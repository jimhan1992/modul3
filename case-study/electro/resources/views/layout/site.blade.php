                        ...
                        <div class="dropdown">
                            ...
                            <div class="cart-dropdown">
                                        ...
                                        @foreach($oldCart['items'] as $key => $item)
                                            <div class="product-widget">
                                                ...
                                                <div class="product-body">
                                                    ...
                                                    <h4 class="product-price"><span class="qty">1x</span>${{ number_format($item->sale_price)}}</h4>
                                                </div>
                                                <a href="{{route('cart.remove',$key)}}"><button class="delete"><i class="fa fa-close"></i></button></a>
                                            </div>
                                        @endforeach
                                    @else
                                        No data
                                ...
                                <div class="cart-summary">
                                    <small>{{$oldCart['totalQuantity']??0}} Item(s) selected</small>
                                    <h5>SUBTOTAL: ${{$oldCart['totalMoney']??0}}</h5>
                                </div>
                                <div class="cart-btns">
                                    <a href="#">View Cart</a>
