    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-xs-6">
                <div class="shop">
                    <div class="shop-img">
                        <img src="{{ asset('site/img/shop01.png') }}" alt="">
                    </div>
                    <div class="shop-body">
            ...
            <div class="col-md-4 col-xs-6">
                <div class="shop">
                    <div class="shop-img">
                        <img src="{{ asset('site/img/shop03.png') }}" alt="">
                    </div>
                    <div class="shop-body">
            ...
            <div class="col-md-4 col-xs-6">
                <div class="shop">
                    <div class="shop-img">
                        <img src="{{ asset('site/img/shop02.png') }}" alt="">
                    </div>
                    <div class="shop-body">
                                ...
                                <div class="product">
                                    <div class="product-img">
                                        ...
                                        <div class="product-label">
                                            <span class="sale">${{$product->sale_price}}-30%</span>
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-name"><a
                                                href="{{route('detail',$product->id)}}">{{$product->name}}</a>
                                        </h3>
                                    ...
                                    <div class="add-to-cart">
                                        <a href="javascript:" onclick="AddCart({{$product->id}})"><button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i>
                                                add
                                                to cart
                                            </button></a>
...
<script>
    function AddCart(id){
        ...
        $("#change-item-cart").empty(); //kiem tr neu co thi xoa di
        $("#change-item-cart").html(response);//thay lai
        });
    }
</script>
@endsection
